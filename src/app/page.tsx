      ...
      <section ref={heroRef} className="relative min-h-[600px] flex items-center justify-center p-6 lg:p-12 overflow-hidden">
        ...
        >
          <div className="flex flex-col gap-4">
            ...
            >
              Markaya değer, <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-accent-1 to-accent-2">dijitale zarafet</span> katıyoruz
            </motion.h1>
            <motion.p
              variants={fadeUp}
          ...
          <motion.div variants={staggerContainer} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <motion.div
                ...
                key={index}
                whileHover="hover"
                className="group flex flex-col gap-4 bg-surface-dark rounded-2xl overflow-hidden shadow-sm hover:shadow-xl hover:shadow-accent-1/5 transition-shadow duration-300 border border-white/5 cursor-pointer"
              >
                <motion.div
